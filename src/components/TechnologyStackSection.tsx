...
const TechnologyStackSection = () => {
  return (
    <section className="w-full text-foreground text-center">
      ...
      <div
        className="w-full max-w-screen-md mx-auto inline-flex flex-nowrap overflow-hidden [mask-image:_linear_gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]"
      >
