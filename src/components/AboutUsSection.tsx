  ...
  return (
    <div className="relative z-10 w-full rounded-xl bg-menubar/10 p-8 text-center text-white shadow-outer-glass backdrop-blur-3xl border border-menubar-border/15 shadow-inner-glass-bottom shadow-inner-glass-stroke supports-[backdrop-filter]:bg-menubar/10">
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="space-y-6">
        ...
        <CollapsibleContent className="space-y-6 text-lg opacity-90 text-left max-w-3xl mx-auto">
          <p>
            As we’ve grown in size and reach, we’ve gained extensive experience
            in integrating the latest technologies into businesses to help them
            thrive in the modern digital landscape.
          </p>
          <p>
            We specialize in growing the face of a business online, expanding
            its audience, and providing smart tools that make service delivery
