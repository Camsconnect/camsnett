          ...
          >
            ...
            <div className="mt-10 text-left">
              <CollapsibleTrigger asChild>
                <Button
                  variant="outline"
                  className="bg-transparent border-brand-neon text-brand-neon hover:bg-brand-neon hover:text-primary-foreground rounded-full px-6 py-3 text-lg transition-colors duration-300"
                >
