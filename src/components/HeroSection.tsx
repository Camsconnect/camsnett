  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 text-center px-4 md:px-6 flex-grow flex flex-col items-center justify-center">
        ...
        <Button size="lg" className="bg-white text-blue-700 hover:bg-gray-100 hover:text-blue-800 text-lg px-6 py-3 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105">
          Get Started
        </Button>
      </div>
    </section>
