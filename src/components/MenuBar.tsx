    ...
    <>
                ...
                >
                  ...
                  <MenubarItem asChild className="p-0">
                    <Button
                      ...
                      className="w-full bg-brand-neon text-primary-foreground hover:bg-brand-neon/90 rounded-none shadow-cta-inner-glow font-normal"
                    >
                      Chat With Us
                    </Button>
                  </MenubarItem>
      ...
      <Dialog open={isContactModalOpen} onOpenChange={setContactModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="py-4">
            <ContactForm onFormSubmit={() => setContactModalOpen(false)} />
          </div>
        </DialogContent>
      </Dialog>
    </>
