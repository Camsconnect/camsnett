...
const designServices = [
  {
    ...
    title: "Logo Design",
    description:
      "We will design a unique and memorable logo to represent your brand's identity.",
    price: "From $50",
    deliverables: ["1 Day Delivery", "3 Digital Samples"],
    image: logoDesignShowcase,
  },
  {
  ...
  },
  {
    ...
    description:
      "Modern networking with our smart, tap-to-share digital business cards.",
    price: "From $7 / month",
  ...
  return (
    <section className="w-full text-foreground">
      ...
      <p className="text-lg text-muted-foreground text-center max-w-3xl mx-auto mb-12">
        From logos to business cards, we craft stunning visuals that tell your
        story and elevate your brand.
      </p>
